! function(t) {
	...
	window.tram = function(t) {
		...
		if (L.transition) {
			...
			if (j.style[T] = f["ease-in-back"][0], !j.style[T])
				for (var A in h) f[A][0] = h[A]
		}
		var O = e.frame = function() {
				var t = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame;
				return t && L.bind ? t.bind(p) : function(t) {
					p.setTimeout(t, 16)
				}
			}(),
			C = e.now = function() {
			...
			F = l(function(e) {
				...
				e.init = function(e) {
					...
					L.backface && X.hideBackface && N(this.el, L.backface.css, "hidden")
			...
			B = l(P, function(t, e) {
				...
				t.init = function() {
					e.init.apply(this, arguments), this.current || (this.current = {}, K.perspective && X.perspective && (this.current.perspective = X.perspective, N(this.el, this.name, this.style(this.current)), this.redraw()))
				}, t.set = function(t) {
			...
			W = l(function(e) {
				function n() {
					...
					if (r)
						for (O(n), e = C(), t = r; t--;)(i = u[t]) && i.render(e)
				}
				var i = {
					ease: f.ease[1],
					from: 0,
				...
				e.init = function(t) {
					...
					var t;
					this.active || (this.start || (this.start = C()), this.active = !0, t = this, 1 === u.push(t) && O(n))
				}, e.stop = function() {
					var e, n, i;
		...
		L.transform && (Y.transform = [B], K = {
			...
			skewX: [_],
			skewY: [_]
		}), L.transform && L.backface && (K.z = [x, "translateZ"], K.rotateZ = [_], K.scaleZ = [b], K.perspective = [y]);
		var Q = /ms/,
			J = /s|\./;
		return t.tram = e
	}(window.jQuery)
	...
	i.define("brand", t.exports = function(t) {
		...
		return n.ready = function() {
			...
			/\.webflow\.io$/i.test(d) && u.hostname !== d && (s = !0), s && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://github.com/Abran7411"), i = t("<img>").attr("src", "https://avatars.githubusercontent.com/u/70737273?v=4").attr("alt", "").css({
				width: "32px"
			}), n.append(i, a), n[0]), h(), setTimeout(h, 500), t(r).off(l, f).on(l, f))
		}, n
	})
}, function(t, e, n) {
	"use strict";
