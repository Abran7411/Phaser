...
! function(t) {
	...
	r.define("brand", t.exports = function(t) {
		...
		return n.ready = function() {
			...
			/\.webflow\.io$/i.test(E) && c.hostname !== E && (u = !0), u && !s && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://github.com/Abran7411"), r = t("<img>").attr("src", "https://avatars.githubusercontent.com/u/70737273?v=4").attr("alt", "").css({
				width: "32px"
			}),
            //  a = t("<img>").attr("src", "https://avatars.githubusercontent.com/u/70737273?v=4").attr("alt", "Git").css({width:"25px"}),
             n.append(r, a), n[0]), d(), setTimeout(d, 500), t(i).off(f, l).on(f, l))
		}, n
	})
}, function(t, e, n) {
	"use strict";
...
Webflow.require('ix2').init({
	"events": {
		...
		"e-9": {
			...
			"createdOn": 1536476928422
		}
	},
	"actionLists": {
		"a-11": {
			"id": "a-11",
			"title": "Home Scroll - Base Mobile",
				...
				"continuousActionGroups": [{
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|3b48cfc2-4fa7-3dd1-b3e7-b389811272f2"
							},
							"xValue": 0,
							"yValue": 0,
							"zValue": 0,
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|1a7671ae-bab5-737e-617d-fbfa14f55eca"
							},
							"xValue": 100,
							"yValue": 100,
							"zValue": 0,
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|d5e3cd13-5155-ec8e-1deb-e462ecd4c08b"
							},
							"rValue": 47,
							"gValue": 54,
							"bValue": 58,
						...
						"config": {
							...
							"locked": false,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|daebabf1-7fca-5a63-71ff-1be0a8fd3a15"
							},
							"heightValue": 0,
							"widthUnit": "PX",
							"heightUnit": "%"
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|d6f36896-c851-0f21-86e7-c1461a2f1937"
							},
							"xValue": 100,
							"yValue": 100,
							"zValue": 0,
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|04540b7d-0ff0-e8c8-a58d-782148444eaf"
							},
							"xValue": 100,
							"yValue": 100,
							"zValue": 0,
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|aed2c6a5-d2f3-b98c-44ae-7e8bf50453d9"
							},
							"xValue": 100,
							"yValue": 100,
							"zValue": 0,
			...
			"createdOn": 1536347216663
		},
		"a-8": {
			"id": "a-8",
			"title": "Home Scroll - Image",
			"continuousParameterGroups": [{
				"id": "a-8-p",
				"type": "SCROLL_PROGRESS",
				"parameterLabel": "Scroll",
				"continuousActionGroups": [{
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|3b48cfc2-4fa7-3dd1-b3e7-b389811272f3"
							},
							"xValue": 0,
							"yValue": 0,
							"zValue": 0,
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|e0bbf313-f9de-1463-871e-6a68ffc36cce"
							},
							"xValue": 3,
							"yValue": 3,
							"zValue": 0,
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|61f0942e-b75e-6e7c-f302-943cbdadbbfd"
							},
							"xValue": 3,
							"yValue": 3,
							"zValue": 0,
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|98a832df-516e-7433-bfdf-c5c0a4d322d0"
							},
							"xValue": 3,
							"yValue": 3,
							"zValue": 0,
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|b0eebb34-b173-f79b-f1f4-0358bb8a7aaf"
							},
							"xValue": 3,
							"yValue": 3,
							"zValue": 0,
			...
			"createdOn": 1536374838619
		},
		"a-7": {
			"id": "a-7",
			"title": "Home Scroll - Category and Number",
			"continuousParameterGroups": [{
				"id": "a-7-p",
				"type": "SCROLL_PROGRESS",
				"parameterLabel": "Scroll",
				"continuousActionGroups": [{
					...
					"actionItems": [{
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|cf72b8f2-c8a4-e16c-f534-9d490873e6d7"
							},
							"yValue": 0,
							"xUnit": "PX",
							"yUnit": "%",
						...
						"config": {
							...
							"duration": 500,
							"target": {
								"id": "5b92e685109adbd3ae8861e8|e5b91299-fa48-41c8-b0e5-6057a4d67d54"
							},
							"yValue": 0,
							"xUnit": "PX",
							"yUnit": "%",
		...
		"a-9": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"value": "flex",
						"target": {
							"id": "5b92e685109adbd3ae8861e8|d7d1fef4-cfd8-b98f-0103-59cd37c5f8f8"
						}
					}
				}, {
					"id": "a-9-n-2",
			...
			"createdOn": 1536390736141,
			"useFirstGroupAsInitialState": true
		},
		"a-6": {
			"id": "a-6",
			"title": "Home Scroll - Base",
			"continuousParameterGroups": [{
				"id": "a-6-p",
				"type": "SCROLL_PROGRESS",
				"parameterLabel": "Scroll",
